...
{
    /// <summary>
    /// Methods to work with a Windows Service.
    /// Code taken from http://stackoverflow.com/questions/358700/how-to-install-a-windows-service-programmatically-in-c
    /// </summary>
    public static class ServiceInstaller
    {
        ...
        /// <summary>
        /// See https://msdn.microsoft.com/en-us/library/windows/desktop/ms682450%28v=vs.85%29.aspx
        /// </summary>
        [DllImport("advapi32.dll", SetLastError = true, CharSet = CharSet.Auto)]
